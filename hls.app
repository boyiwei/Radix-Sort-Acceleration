<project xmlns="com.autoesl.autopilot.project" name="Radix_Sort_Acceleration" top="radix_sort">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="../radix_sort_tb.c" sc="0" tb="1" cflags=" -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        ...
        <file name="Radix_Sort_Acceleration/merge_sort.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
